    ...
    PokemonTrainer.prototype.getPokemons = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listPokemons = this.listOfIds.map(function (id) { return (0, utils_1.getSinglePokemon)(id); });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(results.map(function (result) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            _b = (_a = this.pokemons).push;
                                            return [4 /*yield*/, new Pokemon_1.Pokemon(result.data)];
